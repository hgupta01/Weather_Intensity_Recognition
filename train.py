...
def parse_args():
    ...
    parser.add_argument("--data_aug", default="randaug", type=str, choices=["randaug", "default"], help="data augmentation")
    ...
    #logging details
    parser.add_argument("--project", default='runs/randaug/', type=str, help="Folder to save logs and checkpoints")
    return parser.parse_args()

def main():
    args = parse_args()
    name = f'{args.backbone}_{args.head}_{args.optimizer}'

    model = getattr(models, args.recognizer)(backbone = args.backbone, 
                                             cls_head = args.head,
    ...
    #dataloader
    train_loader = utils.create_video_dataloader(root_path=args.data_root, 
                                                 ...
                                                 format=args.format)
    val_loader = utils.create_video_dataloader(root_path=args.data_root, 
