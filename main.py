...
from ops.custom_transform import (
    StackPIL, MergeImageStack, RandomErasingVideo, Rearrange, RandomScaleShortSideAndAspectRatio
)
from torchvision.transforms import (
    Compose,
    Lambda,
    RandomCrop,
    RandomPerspective,  # [...,H,W]
    ColorJitter,  # [..., 1 or 3, H, W]
    Normalize,
    RandomResizedCrop,
)
...
def create_train_transform(imgsz=224):
    print(f"Using image size of {imgsz}")
...
def main():
    ...
    # Dataset config
    # number of classes, txt file for train videos, txt file for val videos, top path to video/image storage folder, file prefix
    num_class, args.train_list, args.val_list, args.root_path, prefix = dataset_config.return_dataset(args.dataset,
                                                                                                      args.modality,
                                                                                                      args.weather)  # modality is RGB for us

    # Result folder name creation
    ...
    if not args.default_transform:
        print("Using custom tranforms.")
        train_transform = create_train_transform()
    else:
        print("Using default tranforms.")
