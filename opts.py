...
parser.add_argument('--lr_steps', default=[30, 40], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
...
parser.add_argument('--default_transform', default=False, action="store_true", help='use default transforms from TSM module')
