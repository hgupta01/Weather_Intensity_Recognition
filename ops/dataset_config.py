...
def return_custom(weather):
    num_classes = 3
    root_data = "dataset/videos/frames/"
    file_imglist_train = os.path.join(
        root_data, "../../data_split/single_label/", weather+"_train.txt")
    file_imglist_val = os.path.join(
        root_data, "../../data_split/single_label/", weather+"_test.txt")
    prefix = "{:03d}.jpg"
    return num_classes, file_imglist_train, file_imglist_val, root_data, prefix


def return_dataset(dataset, modality, weather=None):
